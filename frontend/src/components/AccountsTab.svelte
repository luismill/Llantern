<script>
  ...
  import { getAccountLogo } from '../utils/icons.js';
      ...
      {#each accounts as account}
        ...
        >
          ...
          <div class="flex justify-between items-start mb-4 w-full">
            ...
            <div class="p-2 bg-dark-bg border border-dark-border group-hover:border-brand/30 rounded-lg text-slate-500 group-hover:text-brand-light transition-colors flex-shrink-0 flex items-center justify-center">
               {@html getAccountLogo(account.name)}
            </div>
          </div>
