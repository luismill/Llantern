...
<div class="space-y-6 animate-fade-in">
  ...
  <TransactionList 
    ...
    {loading} 
    on:drilldown={(e) => {
      drilldownType = e.detail.type;
      drilldownValue = e.detail.value;
    }}
  />
</div>

{#if drilldownType && drilldownValue}
  <EntityModal 
    filterType={drilldownType} 
    filterValue={drilldownValue} 
    on:close={() => { drilldownType = null; drilldownValue = null; }} 
  />
{/if}
